    ...
    return BlocConsumer<AuthenticationCubit, AuthenticationState>(
      listener: (context, state) {
        if (state is AuthenticationLoading) {
          ...
          if (state.exists) {
            showErrorOverlayMessage(context, errorMessage: 'Email already exists', subMessage: 'This email already exists, sign in to continue.');
          } else {
                      ...
                      Button(
                        ontap: () async {
                          if (formKey.currentState!.validate()) {
                            ...
                            if (email != null) {
                              context.read<AuthenticationCubit>().checkEmail(email!); 
                            }
                          }
                        },
